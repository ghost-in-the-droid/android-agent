...
The project includes an MCP server that exposes the full mobile automation tool catalog to any AI client. If you cloned this repo, the `.mcp.json` is already configured.
