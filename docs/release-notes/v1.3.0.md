...
<p align="center">
  <a href="../assets/hero-reel.mp4"><img src="../assets/hero-poster.jpg" alt="Ghost driving nine real phones — click to watch (7.8MB, 32s)" width="820" /></a>
</p>
<p align="center"><sub><a href="../assets/hero-reel.mp4">▶ Play the 32s master reel</a></sub></p>
...
<table>
<tr>
<td width="33%"><a href="../assets/videos/mcp-claude-code-tui.mp4"><img src="../assets/videos/mcp-claude-code-tui-poster.png" width="260" alt="Claude Code drives the phone"/></a><br/><sub><b>Claude Code</b>: type in the TUI, watch it drive the phone.</sub></td>
<td width="33%"><a href="../assets/videos/mcp-codex-tui.mp4"><img src="../assets/videos/mcp-codex-tui-poster.png" width="260" alt="Codex drives the phone"/></a><br/><sub><b>Codex</b>: OpenAI's CLI operating a real phone over MCP.</sub></td>
<td width="33%"><a href="../assets/videos/mcp-agy-tui.mp4"><img src="../assets/videos/mcp-agy-tui-poster.png" width="260" alt="Antigravity drives the phone"/></a><br/><sub><b>Antigravity</b>: Google's agent, same 62-tool body.</sub></td>
</tr>
</table>
...
<table>
<tr>
<td width="33%"><a href="../assets/videos/ghost-cli.mp4"><img src="../assets/videos/ghost-cli-poster.png" width="260" alt="Ghost CLI one-liner"/></a><br/><sub><b>Ghost CLI</b>: `ghost "check reddit" --device asus`.</sub></td>
<td width="33%"><a href="../assets/videos/langchain.mp4"><img src="../assets/videos/langchain-poster.png" width="260" alt="LangChain adapter"/></a><br/><sub><b>LangChain</b>: Ghost's tools in a framework agent.</sub></td>
<td width="33%"><a href="../assets/videos/web-chat-gui.mp4"><img src="../assets/videos/web-chat-gui-poster.png" width="260" alt="Web chat drives phone"/></a><br/><sub><b>Web chat</b>: chat in your browser, it drives a real phone.</sub></td>
</tr>
</table>
...
<table>
<tr>
<td width="33%"><a href="../assets/videos/on-device-android.mp4"><img src="../assets/videos/on-device-android-poster.png" width="260" alt="On-device Android"/></a><br/><sub><b>On-device Android</b>: model runs in the app, airplane mode.</sub></td>
<td width="33%"><a href="../assets/videos/on-device-ios.mp4"><img src="../assets/videos/on-device-ios-poster.png" width="260" alt="On-device iPhone"/></a><br/><sub><b>On-device iPhone</b>: your iPhone talks to itself.</sub></td>
<td width="33%"><a href="../assets/videos/iphone-duolingo.mp4"><img src="../assets/videos/iphone-duolingo-poster.png" width="260" alt="iPhone real-app control"/></a><br/><sub><b>iPhone, real app</b>: Ghost does the Duolingo lesson.</sub></td>
</tr>
</table>
